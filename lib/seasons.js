...
//   snakes   — [[z, na], …], na < z
//   bonuses  — [[pole, pkt], …]
//   forks    — [[z, wygrana, przegrana, [oczka]], …]: ROZWIDLONA drabina. Kto na nią
//              wejdzie, rzuca jeszcze raz: wynik z listy oczek = pole „wygrana", inaczej
//              pole „przegrana". Oba cele muszą być dalej niż start drabiny.
//
...
function validate(b) {
  ...
  if (!Array.isArray(forks)) errors.push('"forks" musi być listą');
    ...
    const [from, win, lose, faces] = Array.isArray(f) ? f : [];
